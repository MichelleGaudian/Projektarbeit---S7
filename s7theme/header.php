 ...
 * (über die Funktion 
 * "get_header()" in den einzelnen Templates).
 * Somit hier sollte das Markup, dass auf jeder 
 * Seite im Header-Bereich
 *  angezeigt wird, zu finden sein.
 * Beginnend mit dem <!DOCTYPE html>; <html> <head>
 *  und öffnenden <body> 
 * Tag - gschlossen wird der </body> und </html> 
 * Tag in der footer.php
*/ ?>
<!DOCTYPE html>
<?php /* die WordPress Funktion "language_attributes
()" gibt das
Attribut "lang" mit der in WordPress eingestellten 
Sprache zurück 
(ZB: lang="de_DE" ) */ ?>
<html lang="<?php language_attributes(); ?>" class="no-js">
<head>
    <?php /* die WordPress Funktion "bloginfo()" 
    gibt nütliche
     Informationen zur Website zurück. Über den 
     Parameter 'show'
      können einzelne Werte ausgegeben werden.
        * bloginfo('charset') gibt den Zeichensatz 
        der eingestellten 
        Sprache zurück (ZB: UTF-8 )
        * https://developer.wordpress.org/reference/functions/bloginfo/
        * Hinweis: wird dieses Theme nur für 
        Sprachen in UTF-8 
        entwickelt, könnte dieser Hardcoded 
        eingefügt werden (also ohne
         Funktionsaufruf)
        */
    ?>
        ...
        <div id="brand">
            <?php /* Ausgabe des Logos aus dem Cusomizer
                    * Bedingung (if) überprüft ob die Funktion existiert
                     - nur der Fall, wenn in der functions.php der 
                     Theme-Support 'custom-logo' aktiviert wurde
                    * the_custom_logo() gibt den <a> Tag inkl. href zur
                     Startseite und verschachtelt den <img> Tag mit dem 
                     Logo und alt-Attribut aus
